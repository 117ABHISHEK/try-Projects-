    ...
    <div className="min-h-screen bg-body-light-grey flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#5d9cec] text-white py-3 px-6 rounded-lg font-semibold text-lg hover:bg-[#4a8cdb] transition-all duration-300 hover:shadow-lg"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link
              to="/patient/register"
              className="text-[#5d9cec] hover:text-[#4a8cdb] font-semibold transition-colors duration-300"
            >
              Register here
            </Link>
          </p>
