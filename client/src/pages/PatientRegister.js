      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Create your patient account to access care services
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#5d9cec] focus:border-transparent transition-all duration-300 ${
          ...
          <button
            type="submit"
            className="w-full bg-[#5d9cec] text-white py-3 px-6 rounded-lg font-semibold text-lg hover:bg-opacity-90 transition-all duration-300 hover:shadow-lg"
          >
            Create Account
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link
              to="/patient/login"
              className="text-[#5d9cec] hover:text-opacity-80 font-semibold transition-colors duration-300"
            >
              Sign in here
            </Link>
          </p>
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="text-charcoal-grey hover:text-[#5d9cec] transition-colors duration-300"
          >
